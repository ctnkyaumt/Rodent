...
public static class Macro
{
    ...
    public static ushort HidToVk(byte hid)
    {
        ...
        if (hid >= 0x59 && hid <= 0x61) return (ushort)(0x61 + (hid - 0x59)); // Numpad 1-9
        return hid switch
        {
            0x27 => 0x30,                       // 0
            ...
            0x39 => 0x14,                       // Caps Lock
            0x46 => 0x2C, 0x47 => 0x91, 0x48 => 0x13, // PrintScreen ScrollLock Pause
            0x53 => 0x90, 0x54 => 0x6F, 0x55 => 0x6A, 0x56 => 0x6D, 0x57 => 0x6B, // Numpad
            0x62 => 0x60, 0x63 => 0x6E, 0x65 => 0x5D, // Numpad 0, Numpad ., Menu
            _ => 0,
        };
    }
    ...
    public static byte VkToHid(int vk)
    {
        ...
        if (vk >= 0x61 && vk <= 0x69) return (byte)(0x59 + (vk - 0x61)); // Numpad 1-9
        return vk switch
        {
            0x30 => 0x27,                       // 0
            0x0D => 0x28,                       // Enter
            ...
            0x2D => 0x49,                       // Insert
            0x14 => 0x39,                       // Caps Lock
            0x2C => 0x46, 0x91 => 0x47, 0x13 => 0x48, // PrintScreen ScrollLock Pause
            0x5D => 0x65,                       // Menu (context) key
            0x90 => 0x53,                       // Num Lock
            0x6F => 0x54, 0x6A => 0x55, 0x6D => 0x56, 0x6B => 0x57, // Numpad / * - +
            0x60 => 0x62, 0x6E => 0x63,         // Numpad 0 and .
            _ => 0,
        };
    }
